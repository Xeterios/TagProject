...
public class WinsComparator implements Comparator<PlayerData> {
    @Override
    public int compare(PlayerData o1, PlayerData o2) {
        ArrayList<LeaderboardType> checkOrder = ComparatorChecker.getCompareOrder(LeaderboardType.Wins);
